...
protected:
  ...
  std::shared_ptr<OdometerCalculator> odometer_calculator_ = std::make_shared<OdometerCalculator>(this->wheelbase_, this->wheeloffset_);
...
TEST_F(OdometerCalculatorTest, odom_270_deg_rotation_left_1s)
{
  ...
  this->steering_velocity[OdometerCalculator::Side::LEFT ] = 0.0;
  this->steering_velocity[OdometerCalculator::Side::RIGHT] = 0.0;
  std::vector<double> end_should{0.0, 0.0, M_PI * 3.0 / 2.0};
  std::vector<double> end_is = this->odometer_calculator_->update(dt,
                                                                  this->start_,
                                                                  this->revolute_velocity,
                                                                  this->steering_velocity);
...
TEST_F(OdometerCalculatorTest, odom_curve_forward_90_deg_1s)
{
  // basic differential drive movement
  double radius = 1.0;
  ...
  this->steering_velocity[OdometerCalculator::Side::LEFT ] =  0.0;
  this->steering_velocity[OdometerCalculator::Side::RIGHT] =  0.0;
  std::vector<double> end_should{radius * angle, 0.0, angle};
  std::vector<double> end_is = this->odometer_calculator_->update(dt,
                                                                  this->start_,
                                                                  this->revolute_velocity,
                                                                  this->steering_velocity);
...
TEST_F(OdometerCalculatorTest, odom_curve_forward_90_deg_2s)
{
  // basic differential drive movement
  double radius = 1.0;
  double angle = M_PI / 2.0;
...
TEST_F(OdometerCalculatorTest, odom_curve_backward_90_deg_1s)
{
  // basic differential drive movement
  double radius = 1.0;
  double angle = M_PI / 2.0;
...
TEST_F(OdometerCalculatorTest, odom_curve_backward_90_deg_2s)
{
  // basic differential drive movement
  double radius = 1.0;
  double angle = M_PI / 2.0;
