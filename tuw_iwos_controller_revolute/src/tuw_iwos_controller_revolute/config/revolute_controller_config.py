...
TypeRevoluteControllerConfig = TypeVar("TypeRevoluteControllerConfig", bound="RevoluteControllerConfig")
...
class RevoluteControllerConfig(AbstractDefaultConfig, AbstractDynamicConfig):
    ...
    def from_file(self, config_file_path: str) -> TypeRevoluteControllerConfig:
    ...
    def from_dynamic_reconfigure(self, dynamic_config: DynamicReconfigureDict) -> TypeRevoluteControllerConfig:
