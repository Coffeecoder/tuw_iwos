...
std::shared_ptr<tuw_nav_msgs::JointsIWS>
MessageTransformer::toJointsIWSPointer(const sensor_msgs::JointState &joint_state)
{
  std::map<Side, int> index_revolute{{Side::LEFT,  -1},
                                     {Side::RIGHT, -1}};
  std::map<Side, int> index_steering{{Side::LEFT,  -1},
...
std::shared_ptr<tuw_nav_msgs::JointsIWS>
MessageTransformer::toJointsIWSPointer(const sensor_msgs::JointStatePtr &joint_state)
{
  std::map<Side, int> index_revolute{{Side::LEFT,  -1},
                                     {Side::RIGHT, -1}};
  std::map<Side, int> index_steering{{Side::LEFT,  -1},
