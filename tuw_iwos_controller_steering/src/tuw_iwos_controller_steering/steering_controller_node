...
class SteeringControllerNode:
    ...
    def __init__(self) -> None:
        ...
        self._config: Optional[SteeringControllerConfig] = None
        self._reconfigure_server: Optional[Server] = None

        self._command_subscriber_topic: str = 'iwos_cmd'
        self._command_publisher_topic: str = 'iwos_cmd_steering'

        self._state_subscriber_topic: str = 'iwos_state_steering_raw'
        self._state_publisher_topic: str = 'iwos_state_steering_tuw'
    ...
    def rad_to_position(self, rad: float) -> int:
    ...
    def position_to_rad(self, position: int) -> float:
        position_range_minimum = 0
        position_range_maximum = 4095
        position_range = position_range_maximum - position_range_minimum + 1
        position_offset = self._config.joint_offset
