...
#ifndef TUW_IWOS_ROS_CONTROL_DISTRIBUTOR_TOOL_LOGGING_TOOL_H
#define TUW_IWOS_ROS_CONTROL_DISTRIBUTOR_TOOL_LOGGING_TOOL_H
...
#endif  // TUW_IWOS_ROS_CONTROL_DISTRIBUTOR_TOOL_LOGGING_TOOL_H
